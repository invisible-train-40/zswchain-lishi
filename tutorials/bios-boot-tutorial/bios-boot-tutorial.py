...
def claimRewards():
    table = getJsonOutput(args.cleos + 'get table zswhq eosio producers -l 100')
    times = []
...
def stepSetSystemContract():
    ...
    # install zswhq.system latest version
...
parser.add_argument('--symbol', metavar='', help="The zswhq.system symbol", default='SYS')
